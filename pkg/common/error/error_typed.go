...
var globalTypedErrorMessages = map[string]ErrorMessage{
	...
	ERR_WORKER_POOL_ADD_TASK_INCORRECT_STATE: {ERR_WORKER_POOL_ADD_TASK_INCORRECT_STATE, "Worker pool has incorrect state to add new task: ['current_state=[%s]', 'required_state=[%s]']"},
	ERR_WORKER_POOL_RUN_INCORRECT_STATE:      {ERR_WORKER_POOL_RUN_INCORRECT_STATE, "Worker pool has incorrect state to run: ['name=[%s]', 'current_state=[%s]', 'required_state=[%s]']"},
	ERR_WORKER_POOL_TASK_INCORRECT_STATE:     {ERR_WORKER_POOL_TASK_INCORRECT_STATE, "Worker pool - task has incorrect state to run: ['name=[%s]', 'current_state=[%s]', 'required_state=[%s]']"},
